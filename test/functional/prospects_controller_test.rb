...
class ProspectsControllerTest < ActionController::TestCase
  ...
  test "should create prospect" do
    assert_difference('Prospect.count') do
      post :create, prospect: { description: @prospect.description, email: @prospect.email, name: @prospect.name }
    end
  ...
  test "should update prospect" do
    put :update, id: @prospect, prospect: { description: @prospect.description, email: @prospect.email, name: @prospect.name }
    assert_redirected_to prospect_path(assigns(:prospect))
  end
